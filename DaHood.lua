...
local DaHood = library:Window("Dahood")

DaHood:Button("Ray-X Hub", function()
    loadstring(game:HttpGet('https://raw.githubusercontent.com/SpaceYes/Lua/Main/DaHood.Lua'))()
end)

DaHood:Button("Con.TXT Hub", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/JsfuayASbsfuWGakCmhzVwaKJsfuayASbsfuWGa/dasdasdasdas/main/ConTXT"))()
end)

DaHood:Button("Sono-lock Hub", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/bobobexz/sono-wow/main/README.md"))()
end)

DaHood:Button("Sono-ware Hub", function()
    loadstring(game:HttpGet("https://raw.githubusercontent.com/bobobexz/sono-op/main/README.md", true))()
    
end)

DaHood:Button("Silent Lock Blue Dot", function()
    game.StarterGui:SetCore("SendNotification", {
        Title = "Toggle C"; -- the title (ofc)
        Text = "Toggle is = C";
...
DaHood:Button("Zapped Hub", function()
    loadstring(game:HttpGet('https://ekso.gq/raw/relases/nixware.lua%27'))()
end)
